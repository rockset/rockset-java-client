...
public class TestDocumentApi {
  ...
  public void setUpOnce() throws Exception {
    ...
    client.collections.create(workspaceName, new CreateCollectionRequest().name(collectionName));
  ...
  public void testAdd() throws Exception {
    ...
    AddDocumentsRequest request = new AddDocumentsRequest().data(list);
  ...
  public void testAddAsync() throws Exception {
    ...
    client.documents.addAsync(
        workspaceName,
        collectionName,
        request,
        new ApiCallback<AddDocumentsResponse>() {
          @Override
          public void onFailure(
              Exception e, int statusCode, Map<String, List<String>> responseHeaders) {
            countDownLatch.countDown();
          }

          @Override
          public void onSuccess(
              AddDocumentsResponse result,
              int statusCode,
