...
public class IntegrationsApi {
   ...
   *     body
   */
  public ApiResponse<CreateIntegrationResponse> createWithHttpInfo(CreateIntegrationRequest body)
      throws Exception {
  ...
  /**
   * Create Integration (asynchronously) Create a new integration.
   *
   * @param body integration credentials (required)
  ...
  public okhttp3.Call createAsync(
      CreateIntegrationRequest body, final ApiCallback<CreateIntegrationResponse> callback)
      throws Exception {
  ...
  private okhttp3.Call deleteValidateBeforeCall(
    ...
    if (integration == null) {
      throw new Exception(
          "Missing the required parameter 'integration' when calling delete(Async)");
    }
   ...
   *     body
   */
  public ApiResponse<DeleteIntegrationResponse> deleteWithHttpInfo(String integration)
      throws Exception {
  ...
  /**
   * Delete Integration (asynchronously) Remove an integration.
   *
   * @param integration name of the integration (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
  ...
  public okhttp3.Call deleteAsync(
      String integration, final ApiCallback<DeleteIntegrationResponse> callback) throws Exception {
    ...
    okhttp3.Call call =
        deleteValidateBeforeCall(integration, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<DeleteIntegrationResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  public okhttp3.Call getAsync(
      String integration, final ApiCallback<GetIntegrationResponse> callback) throws Exception {
    ...
    okhttp3.Call call =
        getValidateBeforeCall(integration, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetIntegrationResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  /**
   * List Integrations List all integrations in an organization.
   *
  ...
  /**
   * List Integrations (asynchronously) List all integrations in an organization.
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call listAsync(final ApiCallback<ListIntegrationsResponse> callback)
      throws Exception {
  ...
  private okhttp3.Call updateValidateBeforeCall(
    ...
    if (integration == null) {
      throw new Exception(
          "Missing the required parameter 'integration' when calling update(Async)");
    }
   ...
   *     body
   */
  public UpdateIntegrationResponse update(String integration, UpdateIntegrationRequest body)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<UpdateIntegrationResponse> updateWithHttpInfo(
      String integration, UpdateIntegrationRequest body) throws Exception {
  ...
  /**
   * Update Integration (asynchronously) Update an existing integration.
   *
   * @param integration (required)
   * @param body integration configuration (required)
   * @param callback The callback to be executed when the API call finishes
  ...
  public okhttp3.Call updateAsync(
      String integration,
      UpdateIntegrationRequest body,
      final ApiCallback<UpdateIntegrationResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        updateValidateBeforeCall(integration, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<UpdateIntegrationResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
