...
import com.rockset.client.model.UpdateIntegrationRequest;
import com.rockset.client.model.UpdateIntegrationResponse;
...
public class IntegrationsApi {
     ...
     */
    public okhttp3.Call createCall(CreateIntegrationRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
    ...
    private okhttp3.Call createValidateBeforeCall(CreateIntegrationRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
     ...
     */
    public okhttp3.Call createAsync(CreateIntegrationRequest body, final ApiCallback<CreateIntegrationResponse> callback) throws Exception {
     ...
     * @throws Exception If fail to serialize the request body object
     */
    public okhttp3.Call deleteCall(String integration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteValidateBeforeCall(String integration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        ...
        okhttp3.Call call = deleteCall(integration, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<DeleteIntegrationResponse> deleteWithHttpInfo(String integration) throws Exception {
        okhttp3.Call call = deleteValidateBeforeCall(integration, null, null);
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call deleteAsync(String integration, final ApiCallback<DeleteIntegrationResponse> callback) throws Exception {
        ...
        okhttp3.Call call = deleteValidateBeforeCall(integration, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteIntegrationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws Exception If fail to serialize the request body object
     */
    public okhttp3.Call getCall(String integration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(String integration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        ...
        okhttp3.Call call = getCall(integration, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetIntegrationResponse> getWithHttpInfo(String integration) throws Exception {
        okhttp3.Call call = getValidateBeforeCall(integration, null, null);
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getAsync(String integration, final ApiCallback<GetIntegrationResponse> callback) throws Exception {
        ...
        okhttp3.Call call = getValidateBeforeCall(integration, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetIntegrationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call listAsync(final ApiCallback<ListIntegrationsResponse> callback) throws Exception {
     ...
     * @param body integration configuration (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws Exception If fail to serialize the request body object
     */
    public okhttp3.Call updateCall(String integration, UpdateIntegrationRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateValidateBeforeCall(String integration, UpdateIntegrationRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        
        // verify the required parameter 'integration' is set
        if (integration == null) {
            throw new Exception("Missing the required parameter 'integration' when calling update(Async)");
        }
        ...
        okhttp3.Call call = updateCall(integration, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UpdateIntegrationResponse update(String integration, UpdateIntegrationRequest body) throws Exception {
        ApiResponse<UpdateIntegrationResponse> resp = updateWithHttpInfo(integration, body);
        return resp.getData();
    }
     ...
     * @param integration  (required)
     * @param body integration configuration (required)
     * @return ApiResponse&lt;UpdateIntegrationResponse&gt;
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UpdateIntegrationResponse> updateWithHttpInfo(String integration, UpdateIntegrationRequest body) throws Exception {
        okhttp3.Call call = updateValidateBeforeCall(integration, body, null, null);
        Type localVarReturnType = new TypeToken<UpdateIntegrationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call updateAsync(String integration, UpdateIntegrationRequest body, final ApiCallback<UpdateIntegrationResponse> callback) throws Exception {
        ...
        okhttp3.Call call = updateValidateBeforeCall(integration, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpdateIntegrationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
