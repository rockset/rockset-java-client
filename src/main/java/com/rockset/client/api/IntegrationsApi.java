...
public class IntegrationsApi {
  ...
  private com.squareup.okhttp.Call deleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        deleteCall(integration, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call listAsync(final ApiCallback<ListIntegrationsResponse> callback)
      throws Exception {
