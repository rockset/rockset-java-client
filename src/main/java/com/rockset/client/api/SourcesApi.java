...
public class SourcesApi {
  ...
  public okhttp3.Call createCall(
    ...
    String localVarPath =
        "/v1/orgs/self/ws/{workspace}/collections/{collection}/sources"
  ...
  private okhttp3.Call createValidateBeforeCall(
    ...
    okhttp3.Call call =
        createCall(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Create a source Create new source in a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param body JSON object (required)
   ...
   *     body
   */
  public GetSourceResponse create(String workspace, String collection, Source body)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetSourceResponse> createWithHttpInfo(
      String workspace, String collection, Source body) throws Exception {
  ...
  /**
   * Create a source (asynchronously) Create new source in a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param body JSON object (required)
  ...
  public okhttp3.Call createAsync(
      ...
      String collection,
      Source body,
      final ApiCallback<GetSourceResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        createValidateBeforeCall(
            workspace, collection, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetSourceResponse>() {}.getType();
  ...
  public okhttp3.Call deleteCall(
    ...
    // create path and map variables
    String localVarPath =
        "/v1/orgs/self/ws/{workspace}/collections/{collection}/sources/{source}"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
  ...
  private okhttp3.Call deleteValidateBeforeCall(
    ...
    okhttp3.Call call =
        deleteCall(workspace, collection, source, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Delete Collection source Delete a collection source
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
   ...
   *     body
   */
  public DeleteSourceResponse delete(String workspace, String collection, String source)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<DeleteSourceResponse> deleteWithHttpInfo(
      String workspace, String collection, String source) throws Exception {
  ...
  /**
   * Delete Collection source (asynchronously) Delete a collection source
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
  ...
  public okhttp3.Call deleteAsync(
    ...
    okhttp3.Call call =
        deleteValidateBeforeCall(
            workspace, collection, source, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<DeleteSourceResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getValidateBeforeCall(
    ...
    okhttp3.Call call =
        getCall(workspace, collection, source, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Retrieve source Get details about a collection source.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
   ...
   *     body
   */
  public GetSourceResponse get(String workspace, String collection, String source)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetSourceResponse> getWithHttpInfo(
      String workspace, String collection, String source) throws Exception {
  ...
  /**
   * Retrieve source (asynchronously) Get details about a collection source.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
  ...
  /**
   * List sources in collection Retrieve all sources in a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   ...
   *     body
   */
  public ApiResponse<ListSourcesResponse> listWithHttpInfo(String workspace, String collection)
      throws Exception {
  ...
  /**
   * List sources in collection (asynchronously) Retrieve all sources in a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param callback The callback to be executed when the API call finishes
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call listAsync(
      String workspace, String collection, final ApiCallback<ListSourcesResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        listValidateBeforeCall(workspace, collection, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ListSourcesResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  public okhttp3.Call resumeCall(
    ...
    // create path and map variables
    String localVarPath =
        "/v1/orgs/self/ws/{workspace}/collections/{collection}/sources/{source}/resume"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
            .replaceAll("\\{" + "collection" + "\\}", apiClient.escapeString(collection.toString()))
            .replaceAll("\\{" + "source" + "\\}", apiClient.escapeString(source.toString()));
  ...
  private okhttp3.Call resumeValidateBeforeCall(
    ...
    okhttp3.Call call =
        resumeCall(workspace, collection, source, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Resume source ingest Resume source ingest
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
   ...
   *     body
   */
  public GetSourceResponse resume(String workspace, String collection, String source)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetSourceResponse> resumeWithHttpInfo(
      String workspace, String collection, String source) throws Exception {
  ...
  /**
   * Resume source ingest (asynchronously) Resume source ingest
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
  ...
  public okhttp3.Call suspendCall(
    ...
    // create path and map variables
    String localVarPath =
        "/v1/orgs/self/ws/{workspace}/collections/{collection}/sources/{source}/suspend"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
            .replaceAll("\\{" + "collection" + "\\}", apiClient.escapeString(collection.toString()))
            .replaceAll("\\{" + "source" + "\\}", apiClient.escapeString(source.toString()));
  ...
  private okhttp3.Call suspendValidateBeforeCall(
    ...
    if (collection == null) {
      throw new Exception(
          "Missing the required parameter 'collection' when calling suspend(Async)");
    }
    ...
    okhttp3.Call call =
        suspendCall(workspace, collection, source, body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Suspend source ingest Suspend source ingest
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
   ...
   *     body
   */
  public GetSourceResponse suspend(
      String workspace, String collection, String source, SuspendSourceRequest body)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetSourceResponse> suspendWithHttpInfo(
      String workspace, String collection, String source, SuspendSourceRequest body)
      throws Exception {
  ...
  /**
   * Suspend source ingest (asynchronously) Suspend source ingest
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
  ...
  public okhttp3.Call suspendAsync(
    ...
    okhttp3.Call call =
        suspendValidateBeforeCall(
            workspace, collection, source, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetSourceResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call updateValidateBeforeCall(
    ...
    okhttp3.Call call =
        updateCall(workspace, collection, source, body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Update a collection source Update details about a collection source.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
   ...
   *     body
   */
  public GetSourceResponse update(
      String workspace, String collection, String source, SourceBase body) throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetSourceResponse> updateWithHttpInfo(
      String workspace, String collection, String source, SourceBase body) throws Exception {
  ...
  /**
   * Update a collection source (asynchronously) Update details about a collection source.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param source id of source (required)
