...
public class UsersApi {
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call deleteAsync(String user, final ApiCallback<DeleteUserResponse> callback)
      throws Exception {
  ...
  /**
   * Retrieve Notification Preferences Get all notification preferences.
   *
  ...
  /**
   * Retrieve Notification Preferences (asynchronously) Get all notification preferences.
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call list_0Async(final ApiCallback<ListUnsubscribePreferencesResponse> callback)
      throws Exception {
   ...
   * @throws Exception If fail to serialize the request body object
   */
  public okhttp3.Call update_0Call(
      String user,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call update_0ValidateBeforeCall(
      String user,
      UpdateUserRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
  ...
  /**
   * Update User Update a user in an organization.
   *
   * @param user email of the user to update (required)
   * @param body JSON object (required)
   * @return User
   ...
   *     body
   */
  public ApiResponse<User> update_0WithHttpInfo(String user, UpdateUserRequest body)
      throws Exception {
  ...
  /**
   * Update User (asynchronously) Update a user in an organization.
   *
   * @param user email of the user to update (required)
   * @param body JSON object (required)
   * @param callback The callback to be executed when the API call finishes
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call update_0Async(
      String user, UpdateUserRequest body, final ApiCallback<User> callback) throws Exception {
    ...
    okhttp3.Call call =
        update_0ValidateBeforeCall(user, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<User>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
