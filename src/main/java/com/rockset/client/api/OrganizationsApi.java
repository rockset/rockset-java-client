...
public class OrganizationsApi {
  ...
  /**
   * Get Organization Retrieve information about current organization.
   *
  ...
  /**
   * Get Organization (asynchronously) Retrieve information about current organization.
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call getAsync(final ApiCallback<OrganizationResponse> callback)
      throws Exception {
