...
public class CollectionsApi {
   ...
   *     body
   */
  public CreateCollectionResponse create(String workspace, CreateCollectionRequest body)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<CreateCollectionResponse> createWithHttpInfo(
      String workspace, CreateCollectionRequest body) throws Exception {
  ...
  /**
   * Create Collection (asynchronously) Create new collection in a workspace.
   *
   * @param workspace name of the workspace (required)
   * @param body JSON object (required)
  ...
  public okhttp3.Call createAsync(
      String workspace,
      CreateCollectionRequest body,
      final ApiCallback<CreateCollectionResponse> callback)
      throws Exception {
  ...
  private okhttp3.Call deleteValidateBeforeCall(
    ...
    okhttp3.Call call =
        deleteCall(workspace, collection, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Delete Collection Delete a collection and all its documents from Rockset.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   ...
   *     body
   */
  public ApiResponse<DeleteCollectionResponse> deleteWithHttpInfo(
  ...
  /**
   * Delete Collection (asynchronously) Delete a collection and all its documents from Rockset.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param callback The callback to be executed when the API call finishes
  ...
  public okhttp3.Call deleteAsync(
      String workspace, String collection, final ApiCallback<DeleteCollectionResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        deleteValidateBeforeCall(workspace, collection, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<DeleteCollectionResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *     body
   */
  public ApiResponse<GetCollectionResponse> getWithHttpInfo(String workspace, String collection)
      throws Exception {
  ...
  public okhttp3.Call getAsync(
      String workspace, String collection, final ApiCallback<GetCollectionResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        getValidateBeforeCall(workspace, collection, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetCollectionResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  public okhttp3.Call get_0Call(
    ...
    // create path and map variables
    String localVarPath =
        "/v1/orgs/self/ws/{workspace}/collections/{collection}/offsets/commit"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
            .replaceAll(
                "\\{" + "collection" + "\\}", apiClient.escapeString(collection.toString()));
  ...
  private okhttp3.Call get_0ValidateBeforeCall(
    ...
    okhttp3.Call call =
        get_0Call(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public GetCollectionCommit get_0(
      String workspace, String collection, GetCollectionCommitRequest body) throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetCollectionCommit> get_0WithHttpInfo(
      String workspace, String collection, GetCollectionCommitRequest body) throws Exception {
  ...
  /**
   * List Collections Retrieve all collections in an organization.
   *
  ...
  /**
   * List Collections (asynchronously) Retrieve all collections in an organization.
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call listAsync(final ApiCallback<ListCollectionsResponse> callback)
      throws Exception {
  ...
  private okhttp3.Call updateValidateBeforeCall(
    ...
    okhttp3.Call call =
        updateCall(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Update Collection Update details about a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param body JSON object (required)
   ...
   *     body
   */
  public GetCollectionResponse update(
      String workspace, String collection, UpdateCollectionRequest body) throws Exception {
   ...
   *     body
   */
  public ApiResponse<GetCollectionResponse> updateWithHttpInfo(
      String workspace, String collection, UpdateCollectionRequest body) throws Exception {
  ...
  /**
   * Update Collection (asynchronously) Update details about a collection.
   *
   * @param workspace name of the workspace (required)
   * @param collection name of the collection (required)
   * @param body JSON object (required)
  ...
  public okhttp3.Call updateAsync(
      ...
      String collection,
      UpdateCollectionRequest body,
      final ApiCallback<GetCollectionResponse> callback)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<ListCollectionsResponse> workspaceWithHttpInfo(String workspace)
      throws Exception {
  ...
  public okhttp3.Call workspaceAsync(
      String workspace, final ApiCallback<ListCollectionsResponse> callback) throws Exception {
