...
public class CollectionsApi {
  ...
  private com.squareup.okhttp.Call getValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getCall(workspace, collection, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call listAsync(final ApiCallback<ListCollectionsResponse> callback)
      throws Exception {
