...
public class CollectionsApi {
     ...
     * @throws Exception If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call list_0Call(String workspace, String collection, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/orgs/self/ws/{workspace}/collections/{collection}/aliases"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
            .replaceAll("\\{" + "collection" + "\\}", apiClient.escapeString(collection.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call list_0ValidateBeforeCall(String workspace, String collection, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        ...
        com.squareup.okhttp.Call call = list_0Call(workspace, collection, progressListener, progressRequestListener);
        return call;
     ...
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListAliasesResponse> list_0WithHttpInfo(String workspace, String collection) throws Exception {
    ...
    /**
     * Get Aliases for Collection (asynchronously)
     * Get all Aliases for a specific Rockset Collection.
     * @param workspace  (required)
     * @param collection  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call list_0Async(String workspace, String collection, final ApiCallback<ListAliasesResponse> callback) throws Exception {
        ...
        com.squareup.okhttp.Call call = list_0ValidateBeforeCall(workspace, collection, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListAliasesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws Exception If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call list_1Call(String workspace, String collection, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/orgs/self/ws/{workspace}/collections/{collection}/lambdas"
            .replaceAll("\\{" + "workspace" + "\\}", apiClient.escapeString(workspace.toString()))
            .replaceAll("\\{" + "collection" + "\\}", apiClient.escapeString(collection.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call list_1ValidateBeforeCall(String workspace, String collection, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws Exception {
        ...
        com.squareup.okhttp.Call call = list_1Call(workspace, collection, progressListener, progressRequestListener);
        return call;
     ...
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListQueryLambdaVersionsResponse list_1(String workspace, String collection) throws Exception {
     ...
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListQueryLambdaVersionsResponse> list_1WithHttpInfo(String workspace, String collection) throws Exception {
    ...
    /**
     * Get Query Lambdas for Collection (asynchronously)
     * Get all Query Lambdas that hit a specific Rockset Collection.
     * @param workspace name of the workspace (required)
     * @param collection name of the collection (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws Exception If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call list_1Async(String workspace, String collection, final ApiCallback<ListQueryLambdaVersionsResponse> callback) throws Exception {
        ...
        com.squareup.okhttp.Call call = list_1ValidateBeforeCall(workspace, collection, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListQueryLambdaVersionsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListCollectionsResponse workspace(String workspace) throws Exception {
        ApiResponse<ListCollectionsResponse> resp = workspaceWithHttpInfo(workspace);
        return resp.getData();
    }
    ...
    /**
     * List Collections for Workspace (asynchronously)
     * Retrieve all collections in a workspace.
     * @param workspace name of the workspace (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
