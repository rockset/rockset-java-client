...
public class VirtualInstancesApi {
  ...
  private com.squareup.okhttp.Call getValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getCall(virtualInstanceId, progressListener, progressRequestListener);
    return call;
  }
  ...
  public com.squareup.okhttp.Call listAsync(
      final ApiCallback<ListVirtualInstancesResponse> callback) throws Exception {
   ...
   * @throws Exception If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call setCall(
      String virtualInstanceId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call setValidateBeforeCall(
      String virtualInstanceId,
      UpdateVirtualInstanceRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    com.squareup.okhttp.Call call =
        setCall(virtualInstanceId, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call setAsync(
      String virtualInstanceId,
      UpdateVirtualInstanceRequest body,
