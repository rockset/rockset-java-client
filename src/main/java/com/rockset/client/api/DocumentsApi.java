...
public class DocumentsApi {
  ...
  private okhttp3.Call addValidateBeforeCall(
      String workspace,
      String collection,
      AddDocumentsRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call patchValidateBeforeCall(
      String workspace,
      String collection,
      PatchDocumentsRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call patchAsync(
      String workspace,
      String collection,
      PatchDocumentsRequest body,
