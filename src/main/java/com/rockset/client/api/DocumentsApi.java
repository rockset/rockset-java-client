...
public class DocumentsApi {
   ...
   */
  public com.squareup.okhttp.Call addCall(
      String workspace,
      String collection,
      AddDocumentsRequest body,
  ...
  private com.squareup.okhttp.Call addValidateBeforeCall(
      String workspace,
      String collection,
      AddDocumentsRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
    ...
    com.squareup.okhttp.Call call =
        addCall(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public ApiResponse<AddDocumentsResponse> addWithHttpInfo(
      String workspace, String collection, AddDocumentsRequest body) throws Exception {
   ...
   */
  public com.squareup.okhttp.Call addAsync(
      String workspace,
      String collection,
      AddDocumentsRequest body,
      final ApiCallback<AddDocumentsResponse> callback)
      throws Exception {
  ...
  private com.squareup.okhttp.Call deleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        deleteCall(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public DeleteDocumentsResponse delete(
      String workspace, String collection, DeleteDocumentsRequest body) throws Exception {
   ...
   *     body
   */
  public ApiResponse<DeleteDocumentsResponse> deleteWithHttpInfo(
      String workspace, String collection, DeleteDocumentsRequest body) throws Exception {
    com.squareup.okhttp.Call call =
        deleteValidateBeforeCall(workspace, collection, body, null, null);
  ...
  public com.squareup.okhttp.Call deleteAsync(
      ...
      String collection,
      DeleteDocumentsRequest body,
      final ApiCallback<DeleteDocumentsResponse> callback)
      throws Exception {
   ...
   * @throws Exception If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call patchCall(
      String workspace,
      String collection,
      PatchDocumentsRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
    Object localVarPostBody = body;
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call patchValidateBeforeCall(
      String workspace,
      String collection,
      PatchDocumentsRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
    ...
    com.squareup.okhttp.Call call =
        patchCall(workspace, collection, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public PatchDocumentsResponse patch(
      String workspace, String collection, PatchDocumentsRequest body) throws Exception {
   ...
   *     body
   */
  public ApiResponse<PatchDocumentsResponse> patchWithHttpInfo(
      String workspace, String collection, PatchDocumentsRequest body) throws Exception {
    com.squareup.okhttp.Call call =
        patchValidateBeforeCall(workspace, collection, body, null, null);
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call patchAsync(
      String workspace,
      String collection,
      PatchDocumentsRequest body,
      final ApiCallback<PatchDocumentsResponse> callback)
      throws Exception {
