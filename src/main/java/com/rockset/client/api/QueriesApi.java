...
public class QueriesApi {
   ...
   */
  public okhttp3.Call cancelCall(
      String queryId,
  ...
  private okhttp3.Call cancelValidateBeforeCall(
      String queryId,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
  ...
  /**
   * Cancel Query Attempts to cancel an actively-running query.
   *
   * @param queryId (required)
  ...
  /**
   * Cancel Query (asynchronously) Attempts to cancel an actively-running query.
   *
   * @param queryId (required)
   ...
   */
  public okhttp3.Call cancelAsync(String queryId, final ApiCallback<CancelQueryResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        cancelValidateBeforeCall(queryId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CancelQueryResponse>() {}.getType();
  ...
  /**
   * Retrieve Query Returns information about a query.
   *
   * @param queryId (required)
  ...
  /**
   * Retrieve Query (asynchronously) Returns information about a query.
   *
   * @param queryId (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call getAsync(String queryId, final ApiCallback<GetQueryResponse> callback)
      throws Exception {
  ...
  private okhttp3.Call get_0ValidateBeforeCall(
    ...
    okhttp3.Call call =
        get_0Call(queryId, cursor, docs, offset, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Retrieve Query Results Page Returns a page of query results.
   *
   * @param queryId (required)
   * @param cursor Cursor to current page. If unset, will default to the first page. (optional)
   * @param docs Number of documents to fetch. (optional)
   ...
   *     body
   */
  public QueryPaginationResponse get_0(String queryId, String cursor, Integer docs, Integer offset)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<QueryPaginationResponse> get_0WithHttpInfo(
  ...
  /**
   * Retrieve Query Results Page (asynchronously) Returns a page of query results.
   *
   * @param queryId (required)
   * @param cursor Cursor to current page. If unset, will default to the first page. (optional)
   * @param docs Number of documents to fetch. (optional)
  ...
  /**
   * List Queries Lists actively queued and running queries.
   *
  ...
  /**
   * List Queries (asynchronously) Lists actively queued and running queries.
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
  ...
  /**
   * Execute SQL Query Make a SQL query to Rockset. If you want to issue the query to a specific
   * Virtual Instance use this https://docs.rockset.com/documentation/reference/queryvirtualinstance
   *
   * @param body JSON object (required)
  ...
  /**
   * Execute SQL Query (asynchronously) Make a SQL query to Rockset. If you want to issue the query
   * to a specific Virtual Instance use this
   * https://docs.rockset.com/documentation/reference/queryvirtualinstance
   *
   * @param body JSON object (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call queryAsync(QueryRequest body, final ApiCallback<QueryResponse> callback)
      throws Exception {
   ...
   * @throws Exception If fail to serialize the request body object
   */
  public okhttp3.Call validateCall(
      QueryRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call validateValidateBeforeCall(
      QueryRequest body,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call validateAsync(
