...
public class AliasesApi {
  ...
  private com.squareup.okhttp.Call deleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        deleteCall(workspace, alias, progressListener, progressRequestListener);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getCall(workspace, alias, progressListener, progressRequestListener);
    return call;
  }
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call listAsync(final ApiCallback<ListAliasesResponse> callback)
      throws Exception {
