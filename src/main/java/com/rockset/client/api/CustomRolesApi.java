...
public class CustomRolesApi {
  ...
  /**
   * Retrieve role Retrieve a role by name for your organization.
   *
   * @param roleName (required)
   * @return RoleResponse
   * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response
  ...
  /**
   * Retrieve role (asynchronously) Retrieve a role by name for your organization.
   *
   * @param roleName (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call getAsync(String roleName, final ApiCallback<RoleResponse> callback)
      throws Exception {
