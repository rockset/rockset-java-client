...
public class ApiKeysApi {
  ...
  public okhttp3.Call getCall(
    ...
    List<Pair> localVarQueryParams = new ArrayList<Pair>();
    List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
    if (reveal != null) localVarQueryParams.addAll(apiClient.parameterToPair("reveal", reveal));
   ...
   *     body
   */
  public ApiResponse<GetApiKeyResponse> getWithHttpInfo(String user, String name, Boolean reveal)
      throws Exception {
  ...
  public okhttp3.Call getAsync(
      String user, String name, Boolean reveal, final ApiCallback<GetApiKeyResponse> callback)
      throws Exception {
    ...
    okhttp3.Call call =
        getValidateBeforeCall(user, name, reveal, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetApiKeyResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call listAsync(String user, final ApiCallback<ListApiKeysResponse> callback)
      throws Exception {
  ...
  /**
   * Update API Key State Update the state of an API key for any user in your organization.
   *
   * @param name Name of the API key. (required)
   * @param user Email of the API key owner. Use &#x60;self&#x60; to specify the currently
   *     authenticated user. (required)
  ...
  /**
   * Update API Key State (asynchronously) Update the state of an API key for any user in your
   * organization.
   *
   * @param name Name of the API key. (required)
   * @param user Email of the API key owner. Use &#x60;self&#x60; to specify the currently
