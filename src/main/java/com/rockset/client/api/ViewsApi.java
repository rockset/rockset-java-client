...
public class ViewsApi {
   ...
   *     body
   */
  public ApiResponse<CreateViewResponse> createWithHttpInfo(
      String workspace, CreateViewRequest body) throws Exception {
  ...
  /**
   * Create View (asynchronously) Create a view
   *
   * @param workspace name of the workspace (required)
   * @param body JSON object (required)
  ...
  public com.squareup.okhttp.Call createAsync(
      String workspace, CreateViewRequest body, final ApiCallback<CreateViewResponse> callback)
      throws Exception {
  ...
  private com.squareup.okhttp.Call deleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        deleteCall(workspace, view, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public ApiResponse<DeleteViewResponse> deleteWithHttpInfo(String workspace, String view)
      throws Exception {
  ...
  /**
   * Delete View (asynchronously) Delete a view
   *
   * @param workspace name of the workspace (required)
   * @param view name of the view (required)
   * @param callback The callback to be executed when the API call finishes
  ...
  public com.squareup.okhttp.Call deleteAsync(
      String workspace, String view, final ApiCallback<DeleteViewResponse> callback)
      throws Exception {
    ...
    com.squareup.okhttp.Call call =
        deleteValidateBeforeCall(workspace, view, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<DeleteViewResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private com.squareup.okhttp.Call getValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        getCall(workspace, view, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Retrieve View Get details about a view
   *
   * @param workspace name of the workspace (required)
   * @param view name of the view (required)
   ...
   *     body
   */
  public ApiResponse<GetViewResponse> getWithHttpInfo(String workspace, String view)
      throws Exception {
  ...
  /**
   * Retrieve View (asynchronously) Get details about a view
   *
   * @param workspace name of the workspace (required)
   * @param view name of the view (required)
   * @param callback The callback to be executed when the API call finishes
  ...
  public com.squareup.okhttp.Call getAsync(
      String workspace, String view, final ApiCallback<GetViewResponse> callback) throws Exception {
    ...
    com.squareup.okhttp.Call call =
        getValidateBeforeCall(workspace, view, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetViewResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  /**
   * List Views Retrieve all views in an organization
   *
  ...
  /**
   * List Views (asynchronously) Retrieve all views in an organization
   *
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call listAsync(final ApiCallback<ListViewsResponse> callback)
      throws Exception {
  ...
  private com.squareup.okhttp.Call updateValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call =
        updateCall(workspace, view, body, progressListener, progressRequestListener);
    return call;
  }
   ...
   *     body
   */
  public UpdateViewResponse update(String workspace, String view, UpdateViewRequest body)
      throws Exception {
   ...
   *     body
   */
  public ApiResponse<UpdateViewResponse> updateWithHttpInfo(
      String workspace, String view, UpdateViewRequest body) throws Exception {
  ...
  /**
   * Update View (asynchronously) Update a view
   *
   * @param workspace name of the workspace (required)
   * @param view name of the view (required)
   * @param body JSON object (required)
  ...
  public com.squareup.okhttp.Call updateAsync(
      ...
      String view,
      UpdateViewRequest body,
      final ApiCallback<UpdateViewResponse> callback)
      throws Exception {
    ...
    com.squareup.okhttp.Call call =
        updateValidateBeforeCall(workspace, view, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<UpdateViewResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   * @throws Exception If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call workspaceCall(
      String workspace,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call workspaceValidateBeforeCall(
      String workspace,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws Exception {
    ...
    com.squareup.okhttp.Call call =
        workspaceCall(workspace, progressListener, progressRequestListener);
    return call;
  }

  /**
   * List Views in Workspace Retrieve all views in a workspace.
   *
   * @param workspace name of the workspace (required)
   * @return ListViewsResponse
   * @throws Exception If fail to call the API, e.g. server error or cannot deserialize the response
  ...
  /**
   * List Views in Workspace (asynchronously) Retrieve all views in a workspace.
   *
   * @param workspace name of the workspace (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws Exception If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call workspaceAsync(
      String workspace, final ApiCallback<ListViewsResponse> callback) throws Exception {
