...
public class QueryInfo {
  ...
  @ApiModelProperty(
      ...
      value = "Time (UTC) that query results expire. Only populated if `status` is `COMPLETE`.")
  ...
  /**
   * The log offset that query results were written to in the destination collection. Only populated
  ...
  /**
   * Information for fetching query results pages. Only populated if &#x60;status&#x60; is
   * &#x60;COMPLETE&#x60;.
   *
   * @return pagination
   */
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "Time (UTC) the query request was first received and queued for execution.")
