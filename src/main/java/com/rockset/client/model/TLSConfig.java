...
public class TLSConfig {
  ...
  /**
   * PEM-formatted certificate chain of the Certificate Authority used to verify remote server. If
   * empty, Rockset, will use publicly trusted CAs
   *
   * @return caCert
   */
  ...
  @ApiModelProperty(
      example = "-----BEGIN CERTIFICATE----- .... -----END CERTIFICATE-----",
      required = true,
      value = "PEM-formatted certificate chain to use for client authentication")
  ...
  @ApiModelProperty(
      example = "1695426751",
      value = "Expiration date of the client certificate (represented as number of ms since epoch)")
  ...
  @ApiModelProperty(
      example = "CN=Sample Cert, OU=R&D, O=Company Ltd.",
      value = "Subject of the client certificate, containing common name and other attributes")
  ...
  @ApiModelProperty(
      ...
      required = true,
      value = "PEM-formatted private key to be used for client authentication")
