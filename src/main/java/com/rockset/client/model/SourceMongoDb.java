...
public class SourceMongoDb {
  ...
  @ApiModelProperty(
      example = "my_database",
      required = true,
      value = "MongoDB database name containing this collection.")
  ...
  /**
   * Whether to get the full document from the MongoDB change stream to enable multi-field
   * expression transformations. Selecting this option will increase load on your upstream MongoDB
   * database.
   *
  ...
  public String toString() {
    ...
    sb.append("    retrieveFullDocument: ")
        .append(toIndentedString(retrieveFullDocument))
        .append("\n");
