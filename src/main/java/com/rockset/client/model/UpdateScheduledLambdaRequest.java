...
public class UpdateScheduledLambdaRequest {
  ...
  @ApiModelProperty(
      example = "qoiwkjndksd",
      value = "The apikey to use when triggering execution of the associated query lambda.")
  ...
  @ApiModelProperty(
      example = "1",
      value = "The number of times to execute this scheduled query lambda.")
  ...
  @ApiModelProperty(
      ...
      value = "The value to use as the authorization header when hitting the webhook.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.apikey, updateScheduledLambdaRequest.apikey)
        && Objects.equals(
            this.resumePermanentError, updateScheduledLambdaRequest.resumePermanentError)
        && Objects.equals(
            this.totalTimesToExecute, updateScheduledLambdaRequest.totalTimesToExecute)
