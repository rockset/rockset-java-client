...
public class CsvParams {
  ...
  public enum ColumnTypesEnum {
    ...
    public static class Adapter extends TypeAdapter<ColumnTypesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ColumnTypesEnum enumeration)
          throws IOException {
  ...
  @ApiModelProperty(
      example = "true",
      value = "If the first line in every object specifies the column names")
  ...
  public String toString() {
    ...
    sb.append("    firstLineAsColumnNames: ")
        .append(toIndentedString(firstLineAsColumnNames))
        .append("\n");
