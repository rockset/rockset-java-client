...
public class SourceSystem {
  ...
  /**
   * The workspace for which collections will have logs created. If unspecified, logs will be
   * created for collections in all workspaces. Currently only supported for the INGEST_LOGS system
   * source.
   *
   * @return workspace
   */
