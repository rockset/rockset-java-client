...
public class FieldMappingV2 {
  ...
  @ApiModelProperty(
      ...
      value = "A user specified string that is a name for this mapping")
  ...
  /**
   * A boolean that determines whether to drop all fields in this document. If set, input and output
