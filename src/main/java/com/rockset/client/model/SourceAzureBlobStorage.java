...
public class SourceAzureBlobStorage {
  ...
  @ApiModelProperty(
      example = "server-logs",
      value = "Name of Azure blob Storage container you want to ingest from.")
  ...
  public int hashCode() {
    return Objects.hash(
        blobBytesTotal, blobCountDownloaded, blobCountTotal, container, pattern, prefix, settings);
  }
  ...
  public String toString() {
    ...
    sb.append("    blobCountDownloaded: ")
        .append(toIndentedString(blobCountDownloaded))
        .append("\n");
