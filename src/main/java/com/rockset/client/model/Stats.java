...
public class Stats {
  ...
  @ApiModelProperty(
      example = "128",
      value = "Total execution time (including time queued) of the query, in milliseconds.")
  ...
  /**
   * Number of bytes in the query result set. Only populated if &#x60;status&#x60; is
   * &#x60;COMPLETE&#x60;. Not populated for INSERT INTO queries.
   *
  ...
  /**
   * Number of documents returned by the query. Only populated if &#x60;status&#x60; is
   * &#x60;COMPLETE&#x60;.
   *
  ...
  public String toString() {
    ...
    sb.append("    resultSetDocumentCount: ")
        .append(toIndentedString(resultSetDocumentCount))
        .append("\n");
