...
public class SourceDynamoDbSettings {
  ...
  /**
   * Each DynamoDB stream can have one to many shards, and Rockset polls each DynamoDB shard at a
   * fixed rate. Decreasing the duration between polls helps reduce ingest latency, while increasing
   * the duration can prevent Rockset from keeping up with the updates. If the latency exceeds 24
   * hours (DynamoDB stream retention duration), Rockset will not be able to process all of the
   * streaming updates. Each request also has a fixed price associated with it. Duration value is of
   * type ISO 8601 (e.g. PT5H, PT4M, PT3S). It doesn&#39;t account for DST, leap seconds and leap
   * years. Minimum value: PT0.25S. Maximum value: PT5M.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
        this.dynamodbStreamPollFrequency, sourceDynamoDbSettings.dynamodbStreamPollFrequency);
  }
  ...
  public String toString() {
    ...
    sb.append("    dynamodbStreamPollFrequency: ")
        .append(toIndentedString(dynamodbStreamPollFrequency))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
