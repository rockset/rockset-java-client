...
public class Status {
  ...
  /**
   * Size in bytes detected for the source at collection initialization. This size can be 0 or null
  ...
  @ApiModelProperty(
      ...
      value = "Last source item processed by ingester.")
  ...
  public int hashCode() {
    return Objects.hash(
        detectedSizeBytes, lastProcessedAt, lastProcessedItem, message, state, totalProcessedItems);
  }
