...
public class Offsets {
  ...
  /**
   * An encoded value representing the most recent offsets that have been committed. If the fence
   * offset is less than or equal to the commit, then passed is true.
   *
   * @return commit
   */
  @JsonProperty("commit")
