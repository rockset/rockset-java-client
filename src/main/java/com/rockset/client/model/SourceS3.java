...
public class SourceS3 {
  ...
  /**
   * Deprecated in favor of &#x60;prefix&#x60;. List of prefixes to paths from which data should be
   * ingested.
   *
   * @return prefixes
   */
  ...
  public String toString() {
    ...
    sb.append("    objectBytesDownloaded: ")
        .append(toIndentedString(objectBytesDownloaded))
        .append("\n");
