...
public class ApiKey {
  ...
  @ApiModelProperty(
      value = "Name of the API key that was used to create this object if one was used.")
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "The expiration date of this API key.")
  ...
  /**
   * This field will only be populated with the full key when creating an API key. Otherwise, it
   * will be an API key identifier of 6 characters.
   *
   * @return key
   */
  @JsonProperty("key")
  ...
  /**
   * Role specifying access control. If not specified, API key will have access to all of the
  ...
  public String toString() {
    ...
    sb.append("    createdByApikeyName: ")
        .append(toIndentedString(createdByApikeyName))
        .append("\n");
