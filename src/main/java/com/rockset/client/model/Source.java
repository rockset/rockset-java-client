...
public class Source {
  ...
  @ApiModelProperty(
      ...
      value = "Unique source identifier.")
  public String getId() {
    return id;
  }
  ...
  @ApiModelProperty(
      ...
      value = "ISO-8601 date when source would be auto resumed, if suspended")
  ...
  @ApiModelProperty(
      example = "2019-01-15T21:48:23Z",
      value = "ISO-8601 date when source was suspended, if suspended")
  ...
  public String toString() {
    ...
    sb.append("    ingestTransformation: ")
        .append(toIndentedString(ingestTransformation))
        .append("\n");
