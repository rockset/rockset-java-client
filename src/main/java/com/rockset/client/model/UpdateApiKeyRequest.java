...
public class UpdateApiKeyRequest {
  ...
  @ApiModelProperty(
      example = "true",
      value = "If set to true, the expiration time for this key will be cleared.")
  ...
  /**
   * If provided, the API key will automatically expire at this time (ISO-8601 format). Requires
   * premium.
   *
   * @return expiryTime
   */
