...
public class AutoScalingPolicy {
  ...
  /**
   * Maximum size Rockset can auto scale the Virtual Instance to. This value should be one of the
   * dedicated sizes greater than or same as the min_size and lower than or same as the current
   * size.
   */
  ...
  public enum MaxSizeEnum {
    ...
    public static class Adapter extends TypeAdapter<MaxSizeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MaxSizeEnum enumeration)
          throws IOException {
  ...
  /**
   * Minimum size Rockset can auto scale the Virtual Instance to. This value should be one of the
   * dedicated sizes lower than or same as the max_size and greater than or same as the current
   * size.
   */
  ...
  public enum MinSizeEnum {
    ...
    public static class Adapter extends TypeAdapter<MinSizeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MinSizeEnum enumeration)
          throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
