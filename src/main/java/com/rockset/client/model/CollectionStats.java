...
@ApiModelProperty(value = "total number of bytes overwritten in writing into the collection during bulk")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(docCount, purgedDocCount, fillProgress, lastQueriedMs, lastUpdatedMs, totalSize, totalIndexSize, rowIndexSize, columnIndexSize, invertedIndexSize, rangeIndexSize, purgedDocSize, bytesInserted, bytesOverwritten, bulkBytesInserted, bulkBytesOverwritten);
  }
