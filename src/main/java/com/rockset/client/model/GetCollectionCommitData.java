...
public class GetCollectionCommitData {
  ...
  /**
   * The max offset passed in the request which is the latest offset that was compared to the
   * commit.
   *
   * @return fence
   */
  ...
  /**
   * True if all the data in the offsets are available to be queried. False if one or more of the
   * offsets is still behind the request offsets.
   *
   * @return passed
   */
  @JsonProperty("passed")
