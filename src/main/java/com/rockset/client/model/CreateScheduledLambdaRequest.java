...
public class CreateScheduledLambdaRequest {
  ...
  @ApiModelProperty(
      example = "ql_name",
      required = true,
      value = "The name of the QL to use for scheduled execution.")
  ...
  @ApiModelProperty(
      example = "abcdef1234",
      value = "The version of the QL to use for scheduled execution.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.apikey, createScheduledLambdaRequest.apikey)
        ...
        && Objects.equals(
            this.totalTimesToExecute, createScheduledLambdaRequest.totalTimesToExecute)
