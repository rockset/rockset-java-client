...
public class QueryResponse {
  ...
  /**
   * Status of query execution. Possible values: &#x60;QUEUED&#x60;, &#x60;RUNNING&#x60;,
   * &#x60;COMPLETED&#x60;, &#x60;ERROR&#x60;.
   */
  ...
  /**
   * Meta information about each column in the result set. Not populated in &#x60;SELECT *&#x60;
   * queries.
   *
   * @return columnFields
   */
  ...
  @ApiModelProperty(
      value = "If this was a write query, this is the log offset the query was written to.")
  ...
  /**
   * Pagination information. Only populated if &#x60;paginate&#x60; is specified in the query
   * request.
   *
   * @return pagination
   */
  ...
  @ApiModelProperty(
      value = "The full path of the executed query lambda. Includes version information.")
  ...
  public String toString() {
    ...
    sb.append("    resultsTotalDocCount: ")
        .append(toIndentedString(resultsTotalDocCount))
        .append("\n");
