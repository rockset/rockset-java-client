...
public class StatusAzureServiceBus {
  ...
  @ApiModelProperty(
      ...
      value = "Service Bus first message processed time in ISO-8601 format.")
  ...
  public StatusAzureServiceBus putSessionsItem(
      String key, StatusAzureServiceBusSession sessionsItem) {
