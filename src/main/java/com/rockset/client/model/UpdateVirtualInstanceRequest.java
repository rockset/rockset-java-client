...
public class UpdateVirtualInstanceRequest {
  ...
  /**
   * The mount type of collections that this Virtual Instance will query. Live mounted collections
   * stay up-to-date with the underlying collection in real-time. Static mounted collections do not
   * stay up-to-date. See
   * https://docs.rockset.com/documentation/docs/virtual-instances#virtual-instance-configuration
   */
  ...
  public enum MountTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<MountTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MountTypeEnum enumeration)
          throws IOException {
  ...
  @ApiModelProperty(
      example = "true",
      value = "Whether Query VI auto-suspend should be enabled for this Virtual Instance.")
  ...
  @ApiModelProperty(
      example = "3600",
      value = "Number of seconds without queries after which the Query VI is suspended")
  ...
  /**
   * When a Virtual Instance is resumed, it will remount all collections that were mounted when the
   * Virtual Instance was suspended.
   *
  ...
  public UpdateVirtualInstanceRequest mountRefreshIntervalSeconds(
  ...
  /**
   * DEPRECATED. Use &#x60;mount_type&#x60; instead. Number of seconds between data refreshes for
   * mounts on this Virtual Instance. The only valid values are 0 and null. 0 means the data will be
   * refreshed continuously and null means the data will never refresh.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.autoScalingPolicy, updateVirtualInstanceRequest.autoScalingPolicy)
        ...
        && Objects.equals(
            this.enableRemountOnResume, updateVirtualInstanceRequest.enableRemountOnResume)
        && Objects.equals(
            this.mountRefreshIntervalSeconds,
            updateVirtualInstanceRequest.mountRefreshIntervalSeconds)
  ...
  public String toString() {
    ...
    sb.append("    enableRemountOnResume: ")
        .append(toIndentedString(enableRemountOnResume))
        .append("\n");
    sb.append("    mountRefreshIntervalSeconds: ")
        .append(toIndentedString(mountRefreshIntervalSeconds))
        .append("\n");
