...
public class SourceAzBlobStorageSettings {
  ...
  /**
   * Rockset scans an Azure blob Storage container based on a defined time interval. The scan
   * frequency determines the length of time between a new scan and the previous scan. If the
   * previous scan finds new objects or updates to existing objects, Rockset immediately scans the
   * bucket again after processing changes from the previous scan. Duration value is of type ISO
   * 8601 (e.g. PT5H, PT4M, PT3S). It doesn&#39;t account for DST, leap seconds and leap years.
   * Minimum value: PT1S. Maximum value: PT1H.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
        this.azblobScanFrequency, sourceAzBlobStorageSettings.azblobScanFrequency);
  }
  ...
  public String toString() {
    ...
    sb.append("    azblobScanFrequency: ")
        .append(toIndentedString(azblobScanFrequency))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
