...
public class BulkStats {
  ...
  /**
   * Size in bytes of documents downloaded from source during an ongoing or completed bulk ingest.
   * This includes documents that are dropped and reingested.
   *
  ...
  /**
   * Size in bytes of documents indexed. This is the total size of documents after transformations
   * and dropping before indexes are built.
   *
  ...
  /**
   * Throughput of documents indexed in the last minute measured in bytes/s. This is based off the
   * data_indexed_bytes size. Throughput during the download stage is shown on a per-source
   * granularity in the sources field of the Collection response.
   *
  ...
  /**
   * Number of documents downloaded from source during an ongoing or completed bulk ingest. This
   * includes documents that are dropped and reingested.
   *
  ...
  @ApiModelProperty(
      example = "50000",
      value = "Bulk ingest compute units in milliseconds used for downloading documents.")
  ...
  @ApiModelProperty(
      ...
      value = "ISO-8601 date of when the downloading stage was completed.")
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "ISO-8601 date of when the finalizing stage was completed.")
  ...
  @ApiModelProperty(
      example = "100000",
      value = "Bulk ingest compute units in milliseconds used for indexing documents.")
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "ISO-8601 date of when the indexing stage was completed.")
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "ISO-8601 date of when the initializing stage was completed.")
  ...
  /**
   * Size in bytes of documents before being indexed. This is the total size of documents after
   * decompression, transformations, and dropping. This is equal to data_indexed_bytes after the
   * indexing stage is done unless there are retries during indexing the data.
   *
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "ISO-8601 date of when the provisioning stage was completed.")
  ...
  @ApiModelProperty(
      example = "2001-08-28T00:23:41Z",
      value = "ISO-8601 date of when the bulk ingest was started.")
  ...
  @ApiModelProperty(
      example = "50000",
      value = "Bulk ingest compute units in milliseconds used for ingest transformation.")
  ...
  public int hashCode() {
    return Objects.hash(
        dataDownloadedBytes,
        dataIndexedBytes,
        dataIndexedThroughputBytes,
        documentsDownloaded,
        downloadComputeMs,
        downloadingStageDoneAt,
        finalizingStageDoneAt,
        indexComputeMs,
        indexingStageDoneAt,
        initializingStageDoneAt,
        preIndexSizeBytes,
        provisioningStageDoneAt,
        startedAt,
        totalIndexSizeBytes,
  ...
  public String toString() {
    ...
    sb.append("    dataDownloadedBytes: ")
        .append(toIndentedString(dataDownloadedBytes))
        .append("\n");
    sb.append("    dataIndexedBytes: ").append(toIndentedString(dataIndexedBytes)).append("\n");
    sb.append("    dataIndexedThroughputBytes: ")
        .append(toIndentedString(dataIndexedThroughputBytes))
        .append("\n");
    sb.append("    documentsDownloaded: ")
        .append(toIndentedString(documentsDownloaded))
        .append("\n");
    sb.append("    downloadComputeMs: ").append(toIndentedString(downloadComputeMs)).append("\n");
    sb.append("    downloadingStageDoneAt: ")
        .append(toIndentedString(downloadingStageDoneAt))
        .append("\n");
    sb.append("    finalizingStageDoneAt: ")
        .append(toIndentedString(finalizingStageDoneAt))
        .append("\n");
    sb.append("    indexComputeMs: ").append(toIndentedString(indexComputeMs)).append("\n");
    sb.append("    indexingStageDoneAt: ")
        .append(toIndentedString(indexingStageDoneAt))
        .append("\n");
    sb.append("    initializingStageDoneAt: ")
        .append(toIndentedString(initializingStageDoneAt))
        .append("\n");
    sb.append("    preIndexSizeBytes: ").append(toIndentedString(preIndexSizeBytes)).append("\n");
    sb.append("    provisioningStageDoneAt: ")
        .append(toIndentedString(provisioningStageDoneAt))
        .append("\n");
    sb.append("    startedAt: ").append(toIndentedString(startedAt)).append("\n");
    sb.append("    totalIndexSizeBytes: ")
        .append(toIndentedString(totalIndexSizeBytes))
        .append("\n");
    sb.append("    transformationComputeMs: ")
        .append(toIndentedString(transformationComputeMs))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
