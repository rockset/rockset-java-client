...
public class RocksetClient {
   ...
   *
   * @param request CreateCollectionRequest object which contains the name and sources for a
   *     collection
  ...
  public CreateCollectionResponse createCollection(
      String workspace, CreateCollectionRequest request) throws Exception {
   ...
   * @throws Exception
   */
  public AddDocumentsResponse addDocuments(
      String workspace, String collectionName, AddDocumentsRequest request) throws Exception {
   ...
   * @throws Exception
   */
  public DeleteDocumentsResponse deleteDocuments(
      String workspace, String collectionName, DeleteDocumentsRequest request) throws Exception {
   ...
   *
   * @param request CreateIntegrationRequest object containing details of the integration to be
   *     created
   ...
   *
   * @param request CreateWorkspaceRequest object which contains the name and description for a
   *     workspace
   ...
   *
   * @param workspaceName Name of the workspace
   * @param request CreateQueryLambdaRequest object which contains information about the Query
   *     Lambda
   * @return QueryLambdaVersionResponse object which contains information about the Query Lambda
   *     created
   * @throws Exception
   */
   ...
   * @param request CreateQueryLambdaTagRequest object which contains information about the Query
   *     Lambda Tag
   * @return QueryLambdaTagResponse object which contains information about the Query Lambda Tag
   *     created
   * @throws Exception
   */
  public QueryLambdaTagResponse createQueryLambdaTag(
      String workspaceName, String queryLambdaName, CreateQueryLambdaTagRequest request)
      throws Exception {
   ...
   * @param request UpdateQueryLambdaRequest object which contains information about the Query
   *     Lambda
  ...
  public QueryLambdaVersionResponse updateQueryLambda(
      String workspaceName, String queryName, UpdateQueryLambdaRequest request, Boolean create)
      throws Exception {
   ...
   * @throws Exception
   */
  public List<QueryLambdaVersion> listQueryLambdaVersions(String tag) throws Exception {
   ...
   * @throws Exception
   */
  public QueryResponse runQueryLambdaByTag(
      String workspaceName, String queryName, String tag, ExecuteQueryLambdaRequest request)
      throws Exception {
   ...
   * @throws Exception
   */
  public QueryResponse runQueryLambdaByVersion(
      String workspaceName, String queryName, String version, ExecuteQueryLambdaRequest request)
      throws Exception {
